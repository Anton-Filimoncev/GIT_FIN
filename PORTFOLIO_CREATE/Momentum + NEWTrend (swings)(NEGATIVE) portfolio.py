...
LIST_list = ['Россия', 'Австралия']
index_list = ['ERUS', '^AXJO']
exchange_list = ['MIC:', 'ASX:']
exchange_yahoo_list = ['.ME', '.AX']
rows_list = [7, 4]
columns_list_first = [1, 1]
columns_list_second = [777, 777]
    ...
    for ticker in tickers:
        ...
        if check == 1:
            ...
            try:
                ...
                Data_for_Portfolio['ncfcommon'] = cashflow_df['Free Cash Flow'] / valuation_and_quality_df[
                ...
                Data_for_Portfolio['Shareholder Yield'] = -(
                            (Data_for_Portfolio['Total Debt'] + cashflow_df['Free Cash Flow'] \
                ...
                Data_for_Portfolio['CURRENT RATIO'] = balance_df['Total Current Assets'] / balance_df[
...
# -------------------------------- РАСЧЕТНЫЙ ЦИКЛ ----------------------------------------
    ...
    for i in range(years_len):
        ...
        Data_for_Portfolio_master_filter.to_excel(f'Mom_Trend(swings)(NEGATIVE) portfolio{list}.xlsx')
