...
# -------------------------------- РАСЧЕТНЫЙ ЦИКЛ ----------------------------------------
    ...
    for i in range(years_len):
        ...
        normal_values = scaler.fit_transform(Data_for_Portfolio_master_filter[['EBITDA/EV']])

        Data_for_Portfolio_master_filter['EBITDA/EV'] = normal_values

        Data_for_Portfolio_master_filter['Total Score'] = Data_for_Portfolio_master_filter['EBITDA/EV']+ \
...
print(Returnez_finish.head(20).round(3))
