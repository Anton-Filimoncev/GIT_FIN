...
# -------------------------------- РАСЧЕТНЫЙ ЦИКЛ ----------------------------------------
    ...
    for i in range(years_len):
        ...
        Data_for_Portfolio_master_filter['Total Score'] = (Data_for_Portfolio_master_filter['Valuation Score']*Valuation_weights) + \
...
Returnez_finish[::-1].to_excel('ReturnS_val_trend_NEGATIVE.xlsx')
